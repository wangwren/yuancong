...
description: "兄弟们，前面几篇全是铺垫——装好了、登录了、套餐也选好了。"
---

> 📚 **系列导航**：上一篇 [06 Coding Plan：订阅套餐与计费](/blog/claude-code/06-coding-plan/) 帮你把钱的事算明白了。这一篇该真刀真枪上手了——从打开终端到跑通第一个任务，让你第一次「成功」。
...
![第一次使用 Claude Code 的五步流程图](https://img.yuancong.ai/guide/claude-code/07-first-run-flow@2x.png)
