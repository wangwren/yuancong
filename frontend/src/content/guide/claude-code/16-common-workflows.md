...
description: "兄弟们，今天聊点最实在的。"
---

> 📚 **系列导航**：上一篇 [15 怎么提问和给指令](/blog/claude-code/15-prompting/) 教你「话怎么说」——把模糊需求拆成精确指令。这一篇换个角度：日常 80% 的活儿就那四类，**每一类我给你一个能直接抄的指令模板**，照着填空就能用。
...
![四类常用工作流速查卡](https://img.yuancong.ai/guide/claude-code/16-four-workflows@2x.png)
