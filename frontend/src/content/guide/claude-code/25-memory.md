---
title: "25 · 记忆系统（memory）：让它跨会话记住你"
description: "先说个新手特别容易踩的坑。"
---

> 📚 **系列导航**：上一篇 [24 插件（Plugins）](/blog/claude-code/24-plugins/) 教你把一堆零碎配置打包成一键装、一键停的插件。这一篇聊一件更底层的事——**怎么让 Claude 跨会话记住你**。不只是你手写的 CLAUDE.md，还有它工作时自己攒下的那本「私人笔记」，你纠正它一句，它就悄悄记下来，下次开工自动想起。
...
![Claude Code 两套记忆系统：你写的 CLAUDE.md 与它自己写的自动记忆](https://img.yuancong.ai/guide/claude-code/25-memory-system@2x.png)
