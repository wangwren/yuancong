---
title: "29 · Agent teams 智能体团队：多会话协作"
description: "「你这屏幕上怎么开着仨 Claude？还都在跑。」"
---

> 📚 **系列导航**：上一篇 [28 skill-creator 使用](/blog/claude-code/28-skill-creator/) 教你造一个能被准确触发的 skill。这一篇上「多智能体协作」——把好几个 Claude Code 会话编成一个团队，**你当工头分活、它们各包一段并行干**，干完你统一验收。
...
![Agent teams 团队结构：工头分活、队友并行、任务板协调、信箱互通](https://img.yuancong.ai/guide/claude-code/29-team-structure@2x.png)
