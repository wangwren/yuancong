...
![Claude Code 首次会话全流程图](https://img.yuancong.ai/guide/claude-code/02-first-session-flow@2x.png)
...
下一篇 **[03 · Claude Code 如何工作](/blog/claude-code/03-how-it-works/)**——掀开盖子看里面：你刚那句「写个 hello world 函数」，是怎么从一句话变成一次精准文件修改的？背后是一套叫「代理循环」的机制，搞懂它，你才算真会用 Claude Code，而不只是会敲命令。
