---
title: "30 · 功能怎么选：CLAUDE.md vs Skill vs Hook vs MCP vs Subagent"
description: "兄弟们，学到这儿，你手里已经攒了一堆扩展点了。"
---

> 📚 **系列导航**：上一篇 [29 Agent teams 智能体团队](/blog/claude-code/29-agent-teams/) 教你用 Agent teams 开多智能体并行协作。这一篇给整个第四组收口——CLAUDE.md、Skill、Hook、MCP、Subagent 一路学下来，全堆在脑子里反而容易选错。我给你一张决策表加一棵决策树，**对着「需求」直接查「该用哪个」，再不纠结**。
...
![从需求出发挑扩展点的决策树](https://img.yuancong.ai/guide/claude-code/30-feature-decision-tree@2x.png)
