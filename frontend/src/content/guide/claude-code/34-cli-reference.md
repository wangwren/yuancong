---
title: "34 · CLI 参考手册：命令与全部标志"
description: "「你这 claude 后面还能跟参数？我一直就光秃秃敲一个 claude 进去啊。」"
---

> 📚 **系列导航**：上一篇 [33 钩子（Hooks）](/blog/claude-code/33-hooks/) 教你在固定事件上自动扣扳机、给 Claude 装上护栏。这一篇回到最朴素的地方——**你在终端敲的那一行 `claude`，到底能跟多少花样**。命令、标志、管道、退出码，一篇查完，配一张随时能翻的对照表。
