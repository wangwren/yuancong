---
title: "31 · settings.json：用户级 / 项目级配置"
description: "这里有件特别容易栽的蠢事，踩过一次就再难忘。"
---

> 📚 **系列导航**：上一篇 [30 功能怎么选：CLAUDE.md vs Skill vs Hook vs MCP vs Subagent](/blog/claude-code/30-choosing-features/) 教你「需求来了该挂哪个扩展点」。这一篇往下挖一层——这些扩展点背后的开关，**到底写进哪个文件、用户级和项目级谁压谁**。`settings.json` 就是 Claude Code 那块总配电盘，今天把它的接线规则一次理清。
...
![Claude Code settings 五层优先级栈：Managed > 命令行 > 本地 > 项目 > 用户](https://img.yuancong.ai/guide/claude-code/31-settings-stack@2x.png)
