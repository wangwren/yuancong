---
title: "43 · Git 工作流：让 Claude 当你的 git 副手"
...
![Claude Code Git 工作流：看 diff → 写 commit → 开 PR；push 永远你亲手敲（deny 焊死）](https://img.yuancong.ai/guide/claude-code/43-git-workflow@2x.png)
