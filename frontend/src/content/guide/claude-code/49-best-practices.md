---
title: "49 · 最佳实践：把零散的好习惯，攒成一套能照着做的心法"
description: "「这 prompt 写得太省了。」"
---

> 📚 **系列导航**：上一篇 [48 综合实战：从零到上线串起所学](/blog/claude-code/48-capstone-project/) 带你把前面所有功能拧成一条完整的开发流。这一篇换个高度——**不教新功能，教「怎么用得好」**。同样的 Claude Code，有人用得顺风顺水，有人天天跟它较劲，差的就是这套官方和老用户磨出来的最佳实践。我把它们汇成几条能照着做的法则，外加一摞「好做法 vs 坏做法」对照表。
...
![Claude Code 最佳实践四步循环：探索（Plan Mode）→ 规划 → 实现 → 提交](https://img.yuancong.ai/guide/claude-code/49-best-practice-flow@2x.png)
