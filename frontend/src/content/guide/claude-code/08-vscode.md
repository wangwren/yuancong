...
![VS Code 扩展市场搜 Claude Code，认准 Anthropic 官方扩展](https://img.yuancong.ai/guide/claude-code/08-extension-search-real.png)
...
![VS Code 里三个打开 Claude 面板的入口位置](https://img.yuancong.ai/guide/claude-code/08-spark-icon-location@2x.png)
...
![VS Code 里 Plan Mode 打开的 Markdown 计划文档，某步旁有内联批注](https://img.yuancong.ai/guide/claude-code/08-plan-mode-review@2x.png)
