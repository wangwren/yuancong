...
description: "第一次用 Claude Code，常会撞见这么一段对话——"
---

> 📚 **系列导航**：上一篇 [02 · 安装与使用](/blog/claude-code/02-install/) 带你把 Claude Code 装好、跑起来。这一篇拆开盖子，看清它到底怎么干活——为什么它能自己读代码、改文件、跑命令，而不只是聊天。
...
![代理循环：想 → 做 → 看](https://img.yuancong.ai/guide/claude-code/03-agent-loop@2x.png)
