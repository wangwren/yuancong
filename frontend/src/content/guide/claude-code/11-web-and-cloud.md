...
description: "我前阵子在高铁上，临时收到一条消息——线上一个仓库的 README 里把安装命令写错了，得赶紧改。"
---

📚 **系列导航**：上一篇 [10 桌面 app（Desktop）](/blog/claude-code/10-desktop/) 帮你把 Claude Code 装成了 Mac / Windows 上的原生应用，跑在你自己机器上。这一篇换个方向——**连装都不用装，浏览器打开就能用**，外加用手机接管你电脑上正在跑的会话。
...
![一个会话，三个入口：本地 / 网页 / 手机](https://img.yuancong.ai/guide/claude-code/11-three-surfaces@2x.png)
