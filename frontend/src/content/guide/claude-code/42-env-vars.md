---
title: "42 · 环境变量：藏在背后那排「总开关」"
description: "都说环境变量是「高阶玩家才碰的东西」，说句实话——这话害了不少人。"
---

> 📚 **系列导航**：上一篇 [41 并行任务](/blog/claude-code/41-parallel-tasks/) 教你怎么把活儿拆开、让多个 Claude 同时开跑。这一篇钻到水面下——**那些控制 Claude Code 怎么连模型、超时多久、要不要上报数据的「总开关」，全靠环境变量拨**。它不在哪个菜单里，藏在你的 shell 和 `settings.json` 里，今天把这排开关认全、拨明白。
