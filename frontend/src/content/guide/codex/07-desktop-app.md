---
title: "07 · 桌面 App 全景"
description: "OpenAI 把 Codex 拆成四个入口，但官网首页的下载大按钮、文档里 app 那一整棵目录、连发布会演示都围着同一个东西转——桌面 App。不是 CLI…"
---

> 📚 **系列导航**：上一篇 [06 跑通第一个任务](/blog/codex/06-first-task/) 让你发出了第一条指令、看着 Codex 真把活干完。这一篇正式进它官方**最主推的入口**——桌面 App，把界面分区、能干的事、关键设置和快捷键一次性铺平。下一篇 [08 命令行 CLI 上手](/blog/codex/08-cli/) 再回终端，把另一条线补齐。
...
![Codex 桌面 App 三栏布局：左导航 → 中对话执行 → 右看结果（Diff / 终端 / 预览）](https://img.yuancong.ai/guide/codex/07-three-pane@2x.png)
...
![桌面 App 五区布局（示意，真机以官方为准）](https://img.yuancong.ai/guide/codex/07-five-zones@2x.png)
...
![Codex 桌面 App 真实界面](https://img.yuancong.ai/guide/codex/07-app-real.png)
...
下一篇 **[08 命令行 CLI 上手](/blog/codex/08-cli/)**——桌面 App 这么香，那 CLI 还学不学？答案是：**要脚本化、要进服务器、要塞进 CI 流水线，桌面 App 干不了这些，CLI 才是正解**。下一篇带你回到终端，把 `codex` 这条命令、交互界面、和自动化场景一次讲透——两条线都拿下，你才算把 Codex 真正用全。
