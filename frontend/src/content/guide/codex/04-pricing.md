---
title: "04 · 订阅与计费"
description: "都说「订阅一个 ChatGPT Plus 就能无脑用 Codex」，但说句实话，Codex 的计费根本不是「订了就随便用」那么简单。"
---

> 📚 **系列导航**：上一篇 [03 安装与登录](/blog/codex/03-install/) 把 Codex 装好、用 ChatGPT 账号或 API key 登进去了。这一篇把账算清楚——**到底该订哪个套餐、钱怎么花的、API key 又是另一回事，以及怎么让额度更耐用**。
...
![ChatGPT 各订阅档位与 Codex 能力对比](https://img.yuancong.ai/guide/codex/04-1-2-subscription.png)
...
**前提**：已按 [03 安装与登录](/blog/codex/03-install/) 装好并登录了 Codex（ChatGPT 订阅或 API key 都行）。**国内用户注意**：登录 ChatGPT 账号、跑云端任务通常需要「魔法上网」，本地用 API key 跑则看你网络能不能直连 OpenAI API。
