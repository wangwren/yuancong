...
description: "说个我刚上手 Codex 时干的蠢事。"
---

> 📚 **系列导航**：上一篇 [10 · 云端 Codex Cloud](/blog/codex/10-cloud/) 把「让 Codex 在远端跑、回头收 PR」这条线讲透了。这一篇拉回本地，聊一份**每个项目都该有、但九成新手写废了**的文件——`AGENTS.md`，Codex 每次开工前都要先读一遍的项目说明书。
...
![AGENTS.md 三层发现链：机器级 ~/.codex/（override 优先）→ 项目层 Git 根逐级累加 → 拼成指令链](https://img.yuancong.ai/guide/codex/11-agents-discovery@2x.png)
...
![AGENTS.md 三层发现链、就近优先](https://img.yuancong.ai/guide/codex/11-discovery-chain@2x.png)
