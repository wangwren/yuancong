---
title: "09 · IDE 扩展（VS Code 等）"
description: "先还原一段我上个月跟同事的真实对话。"
---

> 📚 **系列导航**：上一篇 [08 命令行 CLI 上手](/blog/codex/08-cli/) 带你在终端里把 `codex` 敲熟了。这一篇把 Codex 搬进 VS Code——同一个代理、同一份配置，换成有图形界面、能并排看 diff 的玩法。下一篇 [10 云端 Codex Cloud](/blog/codex/10-cloud/) 再把活儿外包到云上跑。
...
比如 VS Code 中搜 codex：
![VS Code 扩展市场搜 codex，认准发布者 OpenAI 的官方扩展](https://img.yuancong.ai/guide/codex/09-extension-marketplace.png)
...
![Codex 扩展输入框下方的三档审批模式切换器](https://img.yuancong.ai/guide/codex/09-approval-switcher.png)
