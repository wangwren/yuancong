---
title: "10 · 云端 Codex Cloud：把活丢上云，喝着咖啡等结果"
description: "兄弟们，今天聊 Codex 四副面孔里最特别的那一张——云端版（Codex cloud）。"
---

> 📚 **系列导航**：上一篇 [09 · IDE 扩展（VS Code 等）](/blog/codex/09-ide/) 把 Codex 塞进了你的编辑器侧边栏——人在哪写代码，它就在哪待命。这一篇换个完全不同的玩法：**你电脑可以关，活照样在云上跑**。下一篇 [11 · 项目说明书 AGENTS.md](/blog/codex/11-agents-md/) 再回头讲怎么把这台「云端机器」调教得听话。
...
![Codex 云端版入口：打开 chatgpt.com/codex](https://img.yuancong.ai/guide/codex/10-cloud-entrance.png)
![首次使用提示连接 GitHub 账号](https://img.yuancong.ai/guide/codex/10-cloud-entrance2.png)
点击中间链接到 GitHub
![点击链接跳转、授权连接 GitHub](https://img.yuancong.ai/guide/codex/10-cloud-connect.png)
关联之后，就可以直接选择仓库进行代码修改了，当然如果不想关联了就进到设置里取消关联即可。
![在设置里管理或取消 GitHub 关联](https://img.yuancong.ai/guide/codex/10-cloud-setting.png)
...
![Codex Cloud 任务流水线：提交 → 建容器拉仓库 → 跑设置脚本（可联网）→ 切 Agent（默认断网）→ 干活 → 交 diff](https://img.yuancong.ai/guide/codex/10-cloud-pipeline@2x.png)
...
![云端任务的流水线](https://img.yuancong.ai/guide/codex/10-cloud-flow@2x.png)
